...
def add_niveau(
    ...
    cycle_id: Annotated[int, Query(
        description="cycle dans lequel le niveau doit etre ajoute")] = ...,
    serie_id: Annotated[int | None, Query(
        description="serie dans lequel le niveau doit etre ajoute")] = None,
):
