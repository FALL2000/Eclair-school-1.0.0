...
class GroupeMatiereEvalueService:
    ...
    def _session(self):
        return self.groupe_matiere_evalue_repository.session

    def _check_code_exists(self, code: str):
        exist_groupe_matiere_evalue = self.groupe_matiere_evalue_repository.findByCode(
            code)
    ...
    def add_groupe_matiere_evalue(self, groupe_matiere_evalue_in: GroupeMatiereEvalueCreateDTO, niveau_id: int):
        try:
            ...
            groupe_matiere_evalue_dict = groupe_matiere_evalue_in.model_dump()
            groupe_matiere_evalue_dict["id_niveau"] = niveau_id
            db_groupe_matiere_evalue = GroupeMatiereEvalue.model_validate(
                groupe_matiere_evalue_dict)
            new_groupe_matiere_evalue = self.groupe_matiere_evalue_repository.save(
                db_groupe_matiere_evalue)
    ...
    def update_groupe_matiere_evalue(
        ...
        try:
            db_groupe_matiere_evalue = self.groupe_matiere_evalue_repository.findOne(
            ...
            update_data = groupe_matiere_evalue_update.model_dump(
                exclude_unset=True)
    ...
    def delete_groupe_matiere_evalue(self, groupe_matiere_evalue_id: int):
        try:
            ...
            delete_groupe_matiere_evalue = self.groupe_matiere_evalue_repository.deleteOne(
                groupe_matiere_evalue_id)
