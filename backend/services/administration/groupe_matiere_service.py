...
class GroupeMatiereService:
    ...
    def _session(self):
        return self.groupe_matiere_repository.session

    def _check_libelle_exists(self, libelle: str):
        exist_groupe_matiere = self.groupe_matiere_repository.findByLibelle(
            libelle)
    ...
    def add_groupe_matiere(self, groupe_matiere_in: GroupeMatiereCreateDTO):
        try:
            ...
            new_groupe_matiere = self.groupe_matiere_repository.save(
                db_groupe_matiere)
    ...
    def update_groupe_matiere(self, groupe_matiere_update: GroupeMatiereUpdateDTO, groupe_matiere_id: int):
        try:
            db_groupe_matiere = self.groupe_matiere_repository.findOne(
                groupe_matiere_id)
    ...
    def delete_groupe_matiere(self, groupe_matiere_id: int):
        try:
            ...
            delete_groupe_matiere = self.groupe_matiere_repository.deleteOne(
                groupe_matiere_id)
