...
class MatiereService:
    ...
    def _session(self):
        return self.matiere_repository.session
    ...
    def add_matiere(self, matiere_in: MatiereCreateDTO, groupe_matiere_id: int):
        try:
            ...
            matiere_dict = matiere_in.model_dump()
            matiere_dict["id_groupe_matiere"] = groupe_matiere_id
            db_matiere = Matiere.model_validate(matiere_dict)
